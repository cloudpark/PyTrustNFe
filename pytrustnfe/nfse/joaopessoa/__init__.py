...
def _send(certificado, method, **kwargs):
    ...
    url = f'https://sispmjp.joaopessoa.pb.gov.br:8443/sispmjp/NfseWSService?wsdl'
    ...
    if method == "RecepcionarLoteRps":
        ...
        # Assina o Lote
        body = signer.sign_xml_webiss(body.encode('utf-8'), "L1", cert_content, key_content, 0)
    ...
    client.set_options(location=f"https://sispmjp.joaopessoa.pb.gov.br:8443/sispmjp/NfseWSService")
